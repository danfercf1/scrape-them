...
let matchbook = async (match) => {
  // Show browser
  // const browser = await puppeteer.launch({headless: false});
  const browser = await puppeteer.launch();
  const page = await browser.newPage();

  await page.goto('https://www.matchbook.com/');
  await page.type('input[type=text]', match);

  // Wait search box
  await page.waitForSelector("#app-next > div > div.Header__header___Uivng.Header__header--searching___1fRlI > div.SearchBar__search___34nHX.SearchBar__search--searching___24Q0S > div.SearchBar__searchList___1JAqy.SearchBar__searchList--active___36hl6 > a:nth-child(2)");
  await page.click("#app-next > div > div.Header__header___Uivng.Header__header--searching___1fRlI > div.SearchBar__search___34nHX.SearchBar__search--searching___24Q0S > div.SearchBar__searchList___1JAqy.SearchBar__searchList--active___36hl6 > a:nth-child(2)");
...
let match = 'Parma vs Lecce';

// matchbook(match).then((value) => {
//   console.log(value);
// });

match = 'Lecce';
geniobet(match).then((value) => {
  console.log(value);
});